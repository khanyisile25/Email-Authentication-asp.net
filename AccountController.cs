...
namespace TestingProject.Controllers
{
    ...
    {
        private static string ApiKey = "AIzaSyBHfN5Fk1fjvsUPJEy7ZQPutt2R3k5Lk-M";
        ...
        public ActionResult Login(string returnUrl)
        {
            try
            {
                ...
                {
                    Console.WriteLine("Jacob is star");
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (token != "")
                    {
                        ...
                        Console.WriteLine("Jacob is star and has new token as: ", token);
